...
\KeywordTok{plot_it}\NormalTok{(}\DecValTok{0}\NormalTok{,}\StringTok{"blue"}\NormalTok{,}\StringTok{"Blues"}\NormalTok{,}\FloatTok{0.5}\NormalTok{,}\StringTok{"HersheySans"}\NormalTok{)}
...
\KeywordTok{with}\NormalTok{(d,}\KeywordTok{plot}\NormalTok{(Value,}
            \DataTypeTok{col=}\NormalTok{col1,}
