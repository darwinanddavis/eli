...
stri_sub(wv,2,1) <- "." # insert the decimal point in the correct place
...
axis(1,at=1:8,labels=rep(month.abb[2:5],each=2))
title("Eli weight (kg) over time")
?par
```
weight
#### Height  
